$(document).ready(function(){
	...
	//Sidebar Accordion Menu:
		...
		$("#main-nav li ul li a.nav-sub-item").click( // When a top menu item is clicked...
				function () {
					$(this).parent().siblings().find("a.nav-sub-item").removeClass("current"); // Remove "current" class from all tabs
