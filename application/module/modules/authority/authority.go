...
import (
	...
	"muidea.com/magicCenter/application/module/modules/authority/def"
	"muidea.com/magicCenter/application/module/modules/authority/handler"
	"muidea.com/magicCenter/application/module/modules/authority/route"
...
func LoadModule(configuration common.Configuration, sessionRegistry common.SessionRegistry, moduleHub common.ModuleHub) {
	...
	instance.routes = route.AppendAuthorityRoute(instance.routes, instance.authorityHandler, instance.accountHandler, moduleHub, sessionRegistry)
